...
class FifthViewController: UIViewController , AVAudioPlayerDelegate {
    ...
    func checkAnswer()   {
        let correctAnswer = all.list4[questionNumber].answer
    ...
    func nextQuestion(){
        if questionNumber <= 9{
            quesPage.text = all.list4[questionNumber].questionText
            nameButton1.setTitle(all.list4[questionNumber].ansA ,for: UIControl.State.normal)
            nameButton2.setTitle(all.list4[questionNumber].ansB ,for: UIControl.State.normal)
            nameButton3.setTitle(all.list4[questionNumber].ansC ,for: UIControl.State.normal)

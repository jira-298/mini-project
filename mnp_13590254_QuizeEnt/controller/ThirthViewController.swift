...
class ThirthViewController: UIViewController , AVAudioPlayerDelegate {
    ...
    func checkAnswer()   {
        let correctAnswer = all.list2[questionNumber].answer
    ...
    func nextQuestion(){
        if questionNumber <= 9{
            quesPage.text = all.list2[questionNumber].questionText
            nameButton1.setTitle(all.list2[questionNumber].ansA ,for: UIControl.State.normal)
            nameButton2.setTitle(all.list2[questionNumber].ansB ,for: UIControl.State.normal)
            nameButton3.setTitle(all.list2[questionNumber].ansC ,for: UIControl.State.normal)

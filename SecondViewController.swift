...
class SecondViewController: UIViewController , AVAudioPlayerDelegate {
    ...
    func nextQuestion(){
        if questionNumber <= 9{
            quesPage.text = all.list[questionNumber].questionText
            nameButton1.setTitle(all.list[questionNumber].ansA ,for: UIControl.State.normal)
            nameButton2.setTitle(all.list[questionNumber].ansB ,for: UIControl.State.normal)
            nameButton3.setTitle(all.list[questionNumber].ansC ,for: UIControl.State.normal)
